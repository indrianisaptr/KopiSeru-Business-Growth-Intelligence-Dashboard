...
def render_sidebar(df: pd.DataFrame) -> dict:
    ...
    st.markdown(
        ...
        section[data-testid="stSidebar"] [data-testid="element-container"]:has([data-baseweb="select"]) {
            ...
            border: 1px solid rgba(255, 255, 255, 0.12) !important;   /* outline tipis terang, bukan gold gelap */
            border-radius: 10px !important;
            padding: 8px 10px 10px 10px !important;
            margin: 4px 0 8px 0 !important;
            box-shadow:
                0 6px 16px rgba(0, 0, 0, 0.45),              /* drop shadow lebih pekat & lebih jauh */
                0 0 0 1px rgba(212, 168, 83, 0.18),           /* rim-light emas tipis di tepi */
        ...
        section[data-testid="stSidebar"] [data-testid="stExpander"]:hover {
            border-color: rgba(200, 155, 109, 0.4) !important;
        ...
        /* Tombol Reset — netral, tidak mencolok, sedikit hover */
        ...
        section[data-testid="stSidebar"] button[kind="secondary"]:hover {
            background-color: rgba(212, 168, 83, 0.16) !important;
        ...
        /* Teks asli label (YEAR/MONTH/dst) ada di <p> di dalam <label> —
           rule blanket "semua teks sidebar putih" di atas menang di <p> ini
           secara langsung, jadi perlu override lebih spesifik di sini. */
    ...
    with st.sidebar:
        ...
        st.markdown("<hr style='margin: 8px 0 6px 0;'>", unsafe_allow_html=True)
